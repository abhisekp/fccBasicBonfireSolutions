...
titleCaseReplace("I'm a little tea pot");
/* 
...
function truncateRegExp(str, num) {
  ...
  return new RegExp("^(.{0," + num + "})(?!.+)$").test(str) ? str : str.slice(0, num - 3) + "...";
}

truncateRegExp("A-tisket a-tasket A green and yellow basket", 11);
